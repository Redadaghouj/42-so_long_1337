...
/*   Updated: 2025/03/02 13:37:25 by mdaghouj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long.h"

void	run_validation_map(char *map_path, t_player *player, t_map_info *map_info)
{
...
int	main(int argc, char *argv[])
{
	...
	if (argc != 2)
		return (EXIT_FAILURE);
	run_validation_map(argv[1], &player, &map_info);
